...
        console.log("Enviando solicitud al Backend para Mintear y Agregar a Venta...");
        
        const response = await fetch(`${API_BASE_URL}/product/agregar`, {
            method: 'POST',
...
            throw new Error(data.message || "Error al procesar la venta en el backend.");
        }
...
        
        const walletContract = new ethers.Contract("0xe1F30Da6B24CE7C6e19e317970E1780f852efB76", WalletABI.abi, signer);
        
